...
<head>
    ...
    <link rel="stylesheet" href="./css/styles.css">
    <title>Configura Individual</title>
</head>
...
<body>
    ...
    <main>
        <div>
            <h2>configura tu compra individual:</h2>
            <form action="formularioIndividual.php" method="post">
                <div class="configura_compra">
                    <div>
                        <label for="personas">Cantidad de personas:</label>
                        <input type="number" id="personas" name="personas" min="1" max="3" required>
                    </div>
                    <div>
                        <label for="periodo">Duración de la Sesión (en horas):</label>
                        <input type="number" id="periodo" name="periodo" min="0.5" step="0.5" placeholder="mínimo: 0.5h" required>
                    </div>
                </div>
                <div>
                    <label>
                    ...
                    <label for="picnic">
                        <div class="box_calcular">
                            ...
                            <b>1. Picnic Natural (15€ por persona):</b>
                            <p name="picnic"><b>Un festín en la naturaleza!</b> Imagina terminar tu sesión de arboterapia con un delicioso picnic en medio del bosque. Nuestro <strong>Picnic Natural</strong> incluye una selección de productos locales y orgánicos,
                    ...
                    <label for="kitNatural">
                        <div class="box_calcular">
                            ...
                            <b>2. Kit de bienestar natural (40€ por persona):</b>
                    ...
                    <label for="transporte">
                        <div class="box_calcular">
                            <b>3. Transporte ecológico ida y vuelta: (20€ por persona):</b>
                    ...
                    <label for="foto">
                        <div class="box_calcular">
                            <b>4. Sesión de fotos profesional: (150€ por sesión):</b>
